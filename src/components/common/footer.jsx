        ...
        <footer className="bg-black text-white ">
            <div className="flex flex-col justify-between  min-h-[60vh]">
                ...
                <div className="flex justify-between items-start p-4 flex-wrap gap-4 ">
                    ...
                    <div className="flex gap-4 flex-wrap">
                        {["FB", "IG", "IN", "BE"].map((item) => (
                            <button
                                key={item}
                                className="border border-white rounded-full px-6 !py-0 text-4xl sm:text-6xl  font-bold hover:bg-white hover:text-black transition !pb-2"
                            >
                                {item}
                            </button>
                        ))}
                ...
                <div className="flex flex-wrap justify-between items-center text-xs p-4 space-y-2 sm:space-y-0 sm:flex-nowrap">
                    ...
                    {/* Back to top */}
                    <div>
                        <a href="#top" className="font-bold hover:underline text-[1rem]">Retour en haut</a>
                    </div>
                </div>
            </div>
        </footer>
